...
//
//	mockgen -package git -source ../../../pkg/git/git.go -destination git.gen.go -write_generate_directive
//
...
//go:generate mockgen -package git -source ../../../pkg/git/git.go -destination git.gen.go -write_generate_directive

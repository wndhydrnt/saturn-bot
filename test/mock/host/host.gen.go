...
//
//	mockgen -package host -source ../../../pkg/host/host.go -destination host.gen.go -write_generate_directive
//
...
//go:generate mockgen -package host -source ../../../pkg/host/host.go -destination host.gen.go -write_generate_directive

...
//
//	mockgen -package command_test -source ../git/git.go -destination gitmock_test.go -write_generate_directive
//
...
//go:generate mockgen -package command_test -source ../git/git.go -destination gitmock_test.go -write_generate_directive

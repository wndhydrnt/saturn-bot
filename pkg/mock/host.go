...
//
//	mockgen -package mock -source ../host/host.go -destination host.go -write_generate_directive
//
...
//go:generate mockgen -package mock -source ../host/host.go -destination host.go -write_generate_directive

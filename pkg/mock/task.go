...
//
//	mockgen -package mock -source ../task/task.go -destination task.go -write_generate_directive
//
...
//go:generate mockgen -package mock -source ../task/task.go -destination task.go -write_generate_directive

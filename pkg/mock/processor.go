...
//
//	mockgen -package mock -source ../processor/processor.go -destination processor.go -write_generate_directive
//
...
//go:generate mockgen -package mock -source ../processor/processor.go -destination processor.go -write_generate_directive

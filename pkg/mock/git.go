...
//
//	mockgen -package mock -source ../git/git.go -destination git.go -write_generate_directive
//
...
//go:generate mockgen -package mock -source ../git/git.go -destination git.go -write_generate_directive

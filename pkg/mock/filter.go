...
// Source: ../filter/filter.go
//
// Generated by this command:
//
//	mockgen -package mock -source ../filter/filter.go -destination filter.go -write_generate_directive
//
...
//go:generate mockgen -package mock -source ../filter/filter.go -destination filter.go -write_generate_directive

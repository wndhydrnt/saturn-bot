...
//
//	mockgen -package processor_test -source ../host/host.go -destination hostmock_test.go -write_generate_directive
//
...
//go:generate mockgen -package processor_test -source ../host/host.go -destination hostmock_test.go -write_generate_directive
